...
<table width="100%" border="0" style="height: 207px; margin-top: 2.5;">
  <tr>
    <td colspan="3" bgcolor="#045FB4" style="height: 23px; border-radius:10px; color:#FFFFFF"> <div align="center" class="abc">Excellent Veterinarians Recommendation </div></td>
  </tr>
  <%
  int time=0;
  ...
  for(int i=0;i<2;i++){
  		...
  		//get 3 pieces
  			...
  			%>
  			<td width="10%"><table width="100%" height="179" style="border-collapse:collapse; border-style:dotted solid dotted dotted; border-width: 0px 1px 0px 0px;">
      <tr>
